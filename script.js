...
class Calculator{
  ...
  switch(this.operation){
    case '+': 
    result = parseFloat(prev.textContent) + parseFloat(curr.textContent) ;
    break;
    case '-': 
    result = parseFloat(prev.textContent) - parseFloat(curr.textContent) ;
    break;
    case '*': 
    result = parseFloat(curr.textContent) * parseFloat(curr.textContent) ;
    break;
    case '/': 
    result = (parseFloat(prev.textContent) / parseFloat(curr.textContent)) ;
  ...
  curr.textContent = result.toFixed(3) ;
  prev.textContent = '';
  this.operation = undefined ;   
